                ...
                <div class="panel-body">
                  <table class="table">
                    <tbody>
                      ...
                      <form class="profile-update form-horizontal " id="profile-update" role="form" method="POST" action="{{ url('/profile/update') }}">
                        @if ($check == null)
                        ...
                        <div class="form-group{{ $errors->has('sex') ? ' has-error' : '' }}">
                          ...
                          <div class="form-group">
                            <tr>
                              ...
                              <td>
                                <a href="/profile" value="取消" class="btn btn-default btn-sm">取消</button>
                              </td>
                            </tr>
                          </div>
