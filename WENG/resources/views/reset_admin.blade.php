...
<div class="container">
    <div class="row" style="margin-top:140px;margin-bottom: 130px;">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    @endif
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/profile_admin/reset_admin') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                ...
                                <a href="/profile_admin" class="btn btn-default btn-sm">
                                    取消
                                </a>
                            </div>
                        </div>
